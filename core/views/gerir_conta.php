    ...
    <div class="row my-5">
        <div class="col-sm-4 offset-sm-4 mb-5">
            ...
            <div class="d-grid gap-2">
                ...
                <a href="?a=alterar_password" class="btn btn-primary text-center">Alterar password</a>
                <a href="?a=ver_encomendas" class="btn btn-primary text-center">Ver todas as encomendas</a>
